...
import fr.mrpiano.hardium.items.WCLayerItem;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class WCLayerBlock extends Block implements HardiumLifecycle {
    ...
    protected WCLayerBlock(HardiumBlockDef def) {
        ...
        if (off >= 0) {
            try {
                ...
                Hardium.log.info("Error parsing 'cnt:' in " + def.blockName);
            }
        }
