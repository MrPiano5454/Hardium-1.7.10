...
import fr.mrpiano.hardium.HardiumBlockDef.Subblock;
import fr.mrpiano.hardium.items.MultiBlockItem;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class WCLeavesBlock extends BlockLeavesBase implements IShearable, HardiumLifecycle {
    ...
    protected WCLeavesBlock(HardiumBlockDef def) {
