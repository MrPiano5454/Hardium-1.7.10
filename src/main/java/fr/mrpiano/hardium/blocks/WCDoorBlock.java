...
import fr.mrpiano.hardium.items.WCDoorItem;
...
public class WCDoorBlock extends BlockDoor implements HardiumLifecycle {
    ...
    protected WCDoorBlock(HardiumBlockDef def) {
