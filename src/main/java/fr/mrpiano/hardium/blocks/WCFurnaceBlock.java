...
import fr.mrpiano.hardium.network.HardiumMessageDest;
import fr.mrpiano.hardium.tileentity.WCFurnaceTileEntity;
...
public class WCFurnaceBlock extends BlockFurnace implements HardiumLifecycle, HardiumMessageDest {
    ...
    protected WCFurnaceBlock(HardiumBlockDef def) {
        super(false);
        this.def = def;
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer player, int par6, float par7, float par8, float par9)
    {
        ...
        else
        {
            ...
            if (te != null) {
                ...
                HardiumChannelHandler.sendBlockMessage(this, p, MSG_OPENWINDOW, data);
