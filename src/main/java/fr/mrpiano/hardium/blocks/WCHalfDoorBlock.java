...
import fr.mrpiano.hardium.items.WCHalfDoorItem;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class WCHalfDoorBlock extends Block implements HardiumLifecycle {
    ...
    protected WCHalfDoorBlock(HardiumBlockDef def) {
    ...
    {
        return Hardium.halfdoorRenderID;
    }
