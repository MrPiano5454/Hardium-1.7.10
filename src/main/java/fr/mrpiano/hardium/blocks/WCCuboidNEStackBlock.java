...
import fr.mrpiano.hardium.items.WCCuboidNEStackItem;
...
public class WCCuboidNEStackBlock extends WCCuboidNEBlock implements HardiumLifecycle {
    ...
    protected WCCuboidNEStackBlock(HardiumBlockDef def) {
        super(def);
        if (def.subBlocks != null) {
            for (HardiumBlockDef.Subblock sb : def.subBlocks) {
                if ((sb.meta & 1) == 0) {
