...
import fr.mrpiano.hardium.tileentity.WCTileEntitySound;
...
public class WCSoundBlock extends WCSolidBlock implements ITileEntityProvider {
    ...
    protected WCSoundBlock(HardiumBlockDef def) {
        super(def);
        for (int i = 0; i < 16; i++) {
            ...
            if (type != null) {
                ...
                for (String tok : toks) {
                    ...
                    if (flds[0].equals("period")) {
                        ...
                        Hardium.log.warning("Invalid type attribute '" + flds[0] + "' in " + def.blockName + "[" + i + "]");
                    }
                }
            }
        }
