...
public class WCFenceBlock extends BlockFence implements HardiumLifecycle {
    ...
    protected WCFenceBlock(HardiumBlockDef def) {
    ...
    public int getRenderType() {
        return Hardium.fenceRenderID;    // Use custom to make inventory render correctly
    }
    @Override
