...
import fr.mrpiano.hardium.items.WCSlabItem;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class WCSlabBlock extends BlockSlab implements HardiumLifecycle {
    ...
    protected WCSlabBlock(HardiumBlockDef def, boolean is_double) {
